...
%:
	echo 'hello world'
	echo 'dadada' > /d/debug/tst2_cmd.txt;
	echo 'dadada2' > /d/debug/tst2_cmd.txt;
	@echo '$(.VARIABLES)'
	@$(foreach var, $(.VARIABLES), echo '$(var)=$($(var))' >> /d/debug/tst2_cmd.txt; );
	@echo 'done with'

$(CGIT_PREFIX).depend:
	echo '' > /d/debug/tst2_cmd.txt
	@$(foreach var, $(.VARIABLES), echo '$(var)=$($(var))' >> /d/debug/tst2_cmd.txt; )


	@mkdir -p $@

$(CGIT_PREFIX)CGIT-CFLAGS: 
	echo '' > /d/debug/tst2_cmd.txt
	@$(foreach var, $(.VARIABLES), echo '$(var)=$($(var))' >> /d/debug/tst2_cmd.txt; )
